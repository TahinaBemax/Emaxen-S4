        ...
        <div class="row">
            ...
            <div class="col-md-5 col-xl-4 text-center text-md-start"
                ...
                <form id="loginForm" data-bs-theme="light">
                    <div class="mb-3">
                        <label for="">Type vehicule</label> <br>
                        <select class="form-select" name="types" placeholder="Type de voiture"
                                style="backdrop-filter: opacity(1);-webkit-backdrop-filter: opacity(1);border-radius: 0px; border-style: none; margin: 0px;padding: 8px 20.8px;padding-top: 8px;box-shadow: -3px 3px 20px rgb(233,233,239);">
                            <?php foreach ($typeVoiture as $type){ ?>
                                <option value="<?= $type['idTypeVoiture'] ?>"><?= $type['type'] ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label for="">Numero de matricule</label> <br>
                        <input class="form-control" type="text" name="matricule" placeholder="Numero matricule"
...
<script src="<?= base_url('assets/js/login-controller.js') ?>"></script>
</body>
