    ...
    <div class="container py-md-5">
        <div class="row">
            <div class="col-md-5 col-xl-4 text-center text-md-start"
                ...
                <h2 class="display-6 fw-bold mb-6">
                        Importation
                </h2>

                <!-- FORM -->
                <form method="post" enctype="multipart/form-data" action="http://localhost/garage/Admin/importServices/" class="d-flex flex-row w-100 mb-3 mt-3" data-bs-theme="light">
                    <div class="col-12">
                        <label for="">Import Service</label> <br>
                        <input class="form-control" required type="file" name="service-csv" placeholder="choose file" accept=".csv, application/vnd.ms-excel, text/csv"
                    ...
                    <div class="col-12 alert alert-box"></div>
                    <button id="btn-submit" class="btn btn-primary d-flex m-auto" data-bss-hover-animate="pulse" type="submit"
                ...
                <form method="post" enctype="multipart/form-data" action="http://localhost/garage/Admin/importTravaux/" class="d-flex flex-row w-100 mb-3 mt-3" data-bs-theme="light">
                    <div class="col-12">
                        <label for="">Import travaux</label> <br>
                        <input class="form-control" required type="file" name="travaux-csv" placeholder="choose file" accept=".csv, application/vnd.ms-excel, text/csv"
                               style="backdrop-filter: opacity(1);-webkit-backdrop-filter: opacity(1);border-radius: 0px;border-style: none;margin: 0px;padding: 8px 20.8px;box-shadow: -4px 4px 20px rgb(229,229,236);padding-top: 10px;">
                    </div>
                    <div class="col-12 alert alert-box"></div>
                    <button id="btn-submit" class="btn btn-primary d-flex m-auto" data-bss-hover-animate="pulse" type="submit"
...
<script src="<?= base_url('assets/js/service-admin-controller.js') ?>"></script>
</body>
