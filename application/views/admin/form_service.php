        ...
        <div class="row">
            ...
            <div class="col-md-5 col-xl-4 text-center text-md-start"
                ...
                <form id="loginForm" data-bs-theme="light">
                    <input type="hidden" name="id" value="<?= (isset($service)) ? $service['idTypeService']: ''?>">
                    <div class="mb-4">
                        <label for="">Type Service</label> <br>
                        <input class="form-control" required type="text" name="type" placeholder="type service" value="<?= (isset($service)) ? $service['type']: '' ?>"
                    ...
                    <div class="mb-4">
                        ...
                        <input class="form-control" required type="time" name="duree" placeholder="Durée" value="<?= (isset($service)) ? $service['duree']: '' ?>"
                               style="backdrop-filter: opacity(1);-webkit-backdrop-filter: opacity(1);border-radius: 0px;border-style: none;margin: 0px;padding: 8px 20.8px;box-shadow: -4px 4px 20px rgb(229,229,236);padding-top: 10px;">
                    </div>
                    <div class="mb-4">
                        <label for="">Montant</label> <br>
                        <input class="form-control" type="number" required min="0" name="montant" placeholder="Montant" value="<?= (isset($service)) ? $service['montant']: '' ?>"
                               style="backdrop-filter: opacity(1);-webkit-backdrop-filter: opacity(1);border-radius: 0px;border-style: none;margin: 0px;padding: 8px 20.8px;box-shadow: -4px 4px 20px rgb(229,229,236);padding-top: 10px;">
                    </div>
                    ...
                    <button id="btn-submit" class="btn btn-primary d-flex m-auto" data-bss-hover-animate="pulse" type="submit"
                        ...
                        <?= (isset($service)) ? "Modifier" : "Inserer" ?>
                    </button>
                </form>
